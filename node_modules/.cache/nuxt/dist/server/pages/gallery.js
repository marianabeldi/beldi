...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, "html{font-family:\"Nunito\",\"Source Sans Pro\",-apple-system,BlinkMacSystemFont,\"Segoe UI\",Roboto,\"Helvetica Neue\",Arial,sans-serif;-moz-osx-font-smoothing:grayscale;-webkit-font-smoothing:antialiased}*,:after,:before{box-sizing:border-box}body{background-color:#012e42;color:#eee8d3;font-size:1.5rem;margin:0}.container{margin:0 auto;min-height:100vh;display:flex;justify-content:center;align-items:center;text-align:center}.title{display:block;font-size:6rem;font-weight:300;letter-spacing:1px}.all-planets{display:flex;flex-wrap:wrap;grid-gap:.5rem 1rem;gap:.5rem 1rem}.all-planets p{background-color:#001b28;font-size:1rem}.all-planets .planet{display:flex;flex-direction:column;justify-content:flex-end;grid-gap:.5rem;gap:.5rem}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/gallery.vue?vue&type=template&id=1962c3c2&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"container"},[_vm._ssrNode("<div>","</div>",[_c('Logo'),_vm._ssrNode(" <h1 class=\"title\"> beldi</h1> <h2>Todos los planetas</h2> "+((!_vm.gettingData)?("<section class=\"all-planets\">"+(_vm._ssrList((_vm.gotData),function(item,i){return ("<div class=\"planet\"><div width=\"300\" height=\"300\">"+(_vm._s(item.svg))+"</div> <p>"+_vm._ssrEscape("by "+_vm._s(item.name))+"</p></div>")}))+"</section>"):"<!---->"))],2)])}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/gallery.vue?vue&type=template&id=1962c3c2&
