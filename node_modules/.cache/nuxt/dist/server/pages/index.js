...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, "html{font-family:\"Nunito\",\"Source Sans Pro\",-apple-system,BlinkMacSystemFont,\"Segoe UI\",Roboto,\"Helvetica Neue\",Arial,sans-serif;-moz-osx-font-smoothing:grayscale;-webkit-font-smoothing:antialiased}*,:after,:before{box-sizing:border-box}body{background-color:#012e42;color:#eee8d3;font-size:1.5rem;margin:0}a{color:#7fffd4}a:hover{opacity:.8}button{background-color:#7fffd4;border:0;border-radius:.3rem;color:#012e42;cursor:pointer;font-size:1.2rem;font-weight:700;min-width:140px;padding:.5rem 1rem}button:hover{opacity:.8}audio{display:block;margin:2rem auto}.container{align-items:center;display:flex;justify-content:center;margin:0 auto;min-height:100vh;padding:1rem;text-align:center}.title{display:block;font-size:5rem;font-weight:300;letter-spacing:1px;margin-bottom:1rem}.intro{max-width:720px}input[type=radio]{margin-right:1rem;height:2rem;width:2rem}.questions-form{display:flex;flex-wrap:wrap}.question-wrapper{display:none}.question-wrapper.active{display:block}.question-wrapper p{font-size:1.6rem;font-weight:700;margin-bottom:1rem;text-align:left}.question-wrapper div label{align-items:center;cursor:pointer;display:flex;margin-bottom:.5rem;padding:.5rem}.question-wrapper div label:hover{color:#7fffd4}.buttons{margin:3rem auto}.buttons button{margin:.5rem}.planeta-final{margin:4rem auto}.textarea-content{margin-bottom:3rem;position:relative}.textarea-content.active:after{background-color:rgba(0,0,0,.6);position:absolute;top:0;left:0;content:\"loading..\";height:100%;width:100%}.nombre{border:1px solid #001b28;border-radius:.3rem;font-size:1.2rem;margin-bottom:.5rem;padding:.5rem}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
installComponents(component, {Logo: __webpack_require__(25).default})
