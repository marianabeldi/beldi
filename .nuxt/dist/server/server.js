...
/******/ 			var chunk = require("./" + ({"1":"components/logo","2":"pages/gallery","3":"pages/index"}[chunkId]||chunkId) + ".js");
...
module.exports = require("vue-supabase");
...
var ___CSS_LOADER_API_IMPORT___ = __webpack_require__(4);
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
___CSS_LOADER_EXPORT___.push([module.i, "@import url(https://fonts.googleapis.com/css2?family=Noto+Sans+JP:wght@400;500;700&display=swap);"]);
// Module
___CSS_LOADER_EXPORT___.push([module.i, "html{font-family:\"Noto Sans JP\",\"Source Sans Pro\",-apple-system,BlinkMacSystemFont,\"Segoe UI\",Roboto,\"Helvetica Neue\",Arial,sans-serif;-moz-osx-font-smoothing:grayscale;-webkit-font-smoothing:antialiased}*,:after,:before{box-sizing:border-box}body{background:#032b49 url(/home-planets.svg);background-size:cover;color:#f2ead3;font-size:1.4rem;margin:0;position:relative}body:before{content:\"\";background:url(/bg-noise.png);display:block;position:absolute;top:0;left:0;width:100%;height:100%;pointer-events:none}.container{align-items:flex-start;display:flex;justify-content:center;margin:0 auto;min-height:100vh;padding:2rem 1rem;text-align:center}.title{display:block;font-size:3.2rem;font-weight:300;letter-spacing:1px;margin-bottom:1rem}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
const _1cfad7d5 = () => interopDefault(__webpack_require__.e(/* import() | pages/gallery */ 2).then(__webpack_require__.bind(null, 30)));

const _4df78815 = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 3).then(__webpack_require__.bind(null, 31)));
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./layouts/default.vue?vue&type=template&id=62a907fb&
var defaultvue_type_template_id_62a907fb_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('Nuxt')],1)}
var defaultvue_type_template_id_62a907fb_staticRenderFns = []


// CONCATENATED MODULE: ./layouts/default.vue?vue&type=template&id=62a907fb&
...
var default_component = Object(componentNormalizer["a" /* default */])(
  script,
  defaultvue_type_template_id_62a907fb_render,
  defaultvue_type_template_id_62a907fb_staticRenderFns,
  false,
...
const components = {
  Logo: () => __webpack_require__.e(/* import() | components/logo */ 1).then(__webpack_require__.bind(null, 23)).then(c => wrapFunctional(c.default || c))
};
...
// EXTERNAL MODULE: external "vue-supabase"
var external_vue_supabase_ = __webpack_require__(13);

// CONCATENATED MODULE: ./.nuxt/supabase.js


const supabase = Object(external_vue_supabase_["createVueSupabase"])({
...
external_vue_default.a.use(supabase); // Inject Supabase into Nuxt Context

/* harmony default export */ var _nuxt_supabase = ((ctx, inject) => {
  // ctx.$supabase = supabase;
  inject("supabase", supabase);
});
// CONCATENATED MODULE: ./.nuxt/supabase-cookie.js
const vuexMutation = "";
const vuexAction = "";
/* harmony default export */ var supabase_cookie = (function ({
  app,
  $supabase,
  store,
  req
...
/* Plugins */
 ...
 // Source: ./supabase-cookie.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {
      ...
      "meta": [{
        ...
        "hid": "description",
        "name": "description",
        "content": "Generador de planetas online. Armá el tuyo y participá de la tapa de \"Espejismo\""
      }, {
        "hid": "og:image",
        "property": "og:image",
        "content": "\u002Fbeldi-espejismo.jpg"
      }, {
        "hid": "og:url",
        "property": "og:url",
        "content": "https:\u002F\u002Fbeldi.netlify.app\u002F"
      }, {
        "hid": "og:description",
  ...
  if (typeof _nuxt_supabase === 'function') {
    await _nuxt_supabase(app.context, inject);
  }

  if (typeof supabase_cookie === 'function') {
    await supabase_cookie(app.context, inject);
