    ...
    <div>
      ...
      <template v-if="currentStep === 6">
        <section class="your-planet">
          ...
          <p>Querés enviarlo y publicarlo?</p>
            <svg ref="planetRef" class="planeta-final" viewBox="0 0 160 160" :width="planet.size" :height="planet.size" xmlns:xlink="http://www.w3.org/1999/xlink">
              ...
              <pattern id="pat1" width="10" height="10" patternUnits="userSpaceOnUse">
                <path d="M.4 4.2C.4.7 6.4.3 6.5 4c.1 3.3-4.8 3.2-5.9.6-.3-.7-.6.7-.4 1.1.8 1.7 2.9 2.7 4.7 2C6.8 7.1 7.4 5 7.1 3.3 6.8 1.4 5.4-.3 3.4 0 1.4.3 0 2.2 0 4.2c0 .5.4.5.4 0z" :fill="planet.color"/>
              </pattern>
          ...
          <pattern id="pat4" width="20" height="24" patternUnits="userSpaceOnUse" patternTransform="rotate(30) skewX(40)">
            ...
            <pattern id="pat5" width="26" height="26" patternUnits="userSpaceOnUse" patternTransform="rotate(20) scale(1)">
              ...
              <pattern id="pat6" width="10" height="7" patternUnits="userSpaceOnUse" patternTransform="rotate(30) scale(1 .5)">
              ...
              <use xlink:href="#planeta" :fill="planet.texture" style="mix-blend-mode: multiply;"/>
